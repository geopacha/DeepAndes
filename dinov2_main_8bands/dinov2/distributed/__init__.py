...
class _TorchDistributedEnvironment:
    def __init__(self):
        self.master_addr = "127.0.0.1" # debug - change 
        self.master_addr = '10.33.2.36'
        self.master_port = 0
        self.rank = -1
        self.world_size = -1
        self.local_rank = -1
    ...
    def _set_from_local(self):
        ...
        # below is the modified code to run on 
        # multiple GPUs on a single node
        # self.master_addr = "10.33.2.36"
        # self.master_port = _get_available_port()  # 6302
        # self.rank = [0,1,2,3,4,5,6,7]
        # self.world_size = 8 
        # self.local_rank = 0 
